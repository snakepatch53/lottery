    ...
    <main style="overflow:hidden">
        <div class="game-container">
            <div class="game-statusbar">
                ...
                <div class="game-statusbar-container" id="element-gift-container-available"></div>
                <h5 class="title">Agotados</h5>
                <div class="game-statusbar-container" id="element-gift-container-exhausted"></div>
            </div>
                        ...
                        for ($x = 0; $x < $lottery_table_r['lottery_table_columns']; $x++) {
                            ...
                            for ($gift_index = 0; $gift_index < count($gift_array); $gift_index++) {
                                if ($gift_array[$gift_index]['gift_row'] == $y and $gift_array[$gift_index]['gift_column'] == $x) {
                                    ...
                                    // if ($gift['gift_img'] == null) $gift_img = $proyect['url'] . 'view/img/gift_open.png';
                                    $gift_index = count($gift_array);
                                    if ($gift['gift_winner'] != "" and $gift['gift_winner'] != null) $isActive = "active";
                                }
                            }
                        ?>
                            <td class="p-0 border-start border-primary td-gift">
                                <div class="item-gift <?= $isActive ?>" gift_id="<?= $gift_id ?>" x="<?= $x ?>" y="<?= $y ?>">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <form class="modal-content" id="formwinner" onsubmit="return false" novalidate>
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-md-12 p-4 text-center" id="element-gift-winn"></div>
